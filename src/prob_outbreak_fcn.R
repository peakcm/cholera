...
# par(mar = c(6,6,6,6))
# plot(seq(0, 3, by=0.01), prob_outbreak_fcn(seq(0, 3, by=0.01), outbreak_size = 5), type="l", ylim = c(0,1), col = "darkgreen", xlab = "R", ylab = "Probability of an Outbreak of at least...\n5, 10, or 50 cases")
